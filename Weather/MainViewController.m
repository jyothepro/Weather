...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
		...
		if (indexPath.row == 0) {
			...
			// 2
			WeatherCondition *weather = [Manager sharedManager].hourlyForecast[indexPath.row - 1];
		...
		if (indexPath.row == 0) {
			...
			// 3
			WeatherCondition *weather = [Manager sharedManager].dailyForecast[indexPath.row - 1];
